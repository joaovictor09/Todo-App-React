    ...
    <div className="w-full h-screen flex flex-col items-center">
      ...
      <div className="max-w-md w-full flex flex-col items-center mt-16 gap-7">
        ...
        <div className="w-full flex flex-col items-center gap-5">
          <button className="w-full bg-violet-500 py-3 font-medium text-white text-base rounded">Entrar</button>
          <a href="" className="text-zinc-200 font-light text-sm underline">Não tem conta? Registre-se</a>
        </div>
      </div>
